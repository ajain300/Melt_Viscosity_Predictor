...
def fit_Mw(M, Y):
    ...
    return {Visc_Constants.a1.value : a1, 
            Visc_Constants.a2.value : a2, 
            Visc_Constants.k1.value : k1, 
            Visc_Constants.k2.value : k2, 
            Visc_Constants.Mcr.value : Mcr}, r2
...
def fit_WLF(T, eta, sigma = None):
    ...
    vars_wlf, _ = curve_fit(WLF_obj, T, eta, p0 = [pT, 17.0,52.0, 8.0], bounds = ((100, -50, 20, -2),(T[-1], 100, 500, 20)) ,sigma=sigma, maxfev = 7000)
    r2 = r2_score(eta, WLF_obj(T, *vars_wlf))
    return {Visc_Constants.c1.value : vars_wlf[1], 
            Visc_Constants.c2.value : vars_wlf[2], 
            Visc_Constants.Tr.value : vars_wlf[0]}, r2